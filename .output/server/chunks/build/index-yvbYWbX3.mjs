...
import { _ as _sfc_main$1, u as useProjects } from './useProjects-CTpKfcnA.mjs';
import { defineComponent, computed, watch, nextTick, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, toRef, isRef, useSSRContext } from 'vue';
...
import { a as useSeoMeta, b as useNuxtApp } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
//# sourceMappingURL=index-yvbYWbX3.mjs.map
