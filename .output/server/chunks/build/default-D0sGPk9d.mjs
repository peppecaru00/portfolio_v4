...
import { mergeProps, ref, withCtx, createVNode, createTextVNode, useSSRContext } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "container flex flex-col py-5 gap-y-6" }, _attrs))}><section class="flex flex-wrap justify-between text-xs text-primary-dark"><article class="flex flex-wrap flex-1 gap-x-5"><div>\xA9 2026 All rights reserved @ Directed by Giuseppe Caruso</div></article><nav class="flex gap-x-2">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=default-D0sGPk9d.mjs.map
